...
describe Order do
    ...
    it { build(:order).should be_valid }
    it { build(:order, status: "").should be_valid }
    it { build(:order, status: "Waiting").should be_valid }
    it { build(:order, status: "AAA").should be_valid }
    it { build(:order, payment: "AAA").should_not be_valid }
