...
describe Product do
    ...
    it { build(:product).should be_valid }
    it { build(:product, category: nil).should_not be_valid }
    it { build(:product, units: "A").should_not be_valid }
    it { build(:product, price: "A").should_not be_valid }
